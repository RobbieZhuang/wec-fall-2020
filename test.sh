...
# python WEC2020/visualize_solution.py -p WEC2020/test_cases/case$2.txt -s solutions/case$2.out -o visualizations/case$2 -v visualizations/case$2/video -f 10
